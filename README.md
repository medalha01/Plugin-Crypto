...
- **iOS support** — Dormant device/simulator XCFramework layout exists under `plugin_crypto/ios/` and `native/ios/`; the platform declaration remains disabled until artifacts are built and validated.
