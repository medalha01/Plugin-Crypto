/// ML-KEM (512/768/1024) and ML-DSA (44/65/87) key creation, uniqueness, cross-algorithm isolation.
...
void main() {
  ...
  group('MlKemKeyCreator', () {
    ...
    test('ML-KEM keys are distinct across 5 calls', () {
      final keys = <String>{};
      for (var i = 0; i < 5; i++) {
        final result = mlKemCreator.create(validMlKem768Spec);
        final pair = (result as CryptoSuccess<KeyPair>).value;
  ...
  group('MlDsaKeyCreator', () {
    ...
    test('ML-DSA keys are distinct across 5 calls', () {
      final keys = <String>{};
      for (var i = 0; i < 5; i++) {
        final result = mlDsaCreator.create(validMlDsa44Spec);
        final pair = (result as CryptoSuccess<KeyPair>).value;
